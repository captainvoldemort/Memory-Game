...
// Flag/Servo Pin definitions
#define FLAG_RED     10
#define FLAG_GREEN   11
#define FLAG_BLUE    12
#define FLAG_YELLOW  13
...
void setup()
{
  servoRed.attach(FLAG_RED);
  servoGreen.attach(FLAG_GREEN);
  servoBlue.attach(FLAG_BLUE);
  servoYellow.attach(FLAG_YELLOW);
...
byte wait_for_button(void)
{
  ...
  while ( (millis() - startTime) < ENTRY_TIME_LIMIT) // Loop until too much time has passed
  {
    ...
    { 
      ...
      delay(50); // This helps with debouncing and accidental double taps
